...
LLM_PARSE_MAX_TOKENS = int(os.getenv("LLM_PARSE_MAX_TOKENS", "300"))
LLM_GENERATION_MAX_TOKENS = int(os.getenv("LLM_GENERATION_MAX_TOKENS", "16384"))
LLM_REPAIR_MAX_TOKENS = int(os.getenv("LLM_REPAIR_MAX_TOKENS", "16384"))
LLM_VALIDATION_MAX_TOKENS = int(os.getenv("LLM_VALIDATION_MAX_TOKENS", "4096"))
